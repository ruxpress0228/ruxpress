...
export const mockPurchaseRequests: PurchaseRequest[] = [
  {
    ...
    productName: 'Wildberries 겨울 코트',
    quantity: 1,
    urls: [{ url: 'https://wildberries.ru/catalog/12345', shop: 'Wildberries' }],
    options: [
      { name: '색상', value: 'Black' },
      { name: '사이즈', value: 'M' }
    ],
  ...
  },
  {
    ...
    productName: 'Ozon 스마트워치',
    quantity: 2,
    urls: [{ url: 'https://ozon.ru/product/67890', shop: 'Ozon' }],
  ...
  },
  {
    ...
    productName: 'Yandex Market 노트북 가방',
    quantity: 1,
    urls: [{ url: 'https://market.yandex.ru/product/11111', shop: 'Yandex Market' }],
    priceRub: 2000,
    priceKrw: 30000,
    exchangeRateId: 1,
    feeAmount: 3600,
...
export const mockInquiries: Inquiry[] = [
  {
    ...
    content: '러시아에서 한국까지 배송 기간이 궁금합니다. 보통 얼마나 걸리나요?',
    status: 'REPLIED',
...
export const mockNotices: Notice[] = [
  ...
  },
  {
    ...
    adminId: 1,
    title: '신규 제휴 쇼핑몰 추가',
    content: '<p>Lamoda.ru와 제휴를 맺어 더 다양한 상품을 구매하실 수 있게 되었습니다.</p>',
    isPinned: false,
    viewCount: 89,
    status: 'PUBLISHED',
